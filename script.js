...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const hoverTargets = document.querySelectorAll('a, button, .btn, .project-link, .social-link, .carousel-btn, .skill-tab');
    ...
    document.addEventListener('mouseover', function(e) {
        if (e.target.closest('a, button, .btn, .project-link, .social-link, .carousel-btn, .skill-tab')) {
